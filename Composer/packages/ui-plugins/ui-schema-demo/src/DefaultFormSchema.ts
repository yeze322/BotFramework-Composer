...
import { FormUISchema } from '@bfc/extension-client';
import { SDKKinds } from '@bfc/shared';
import formatMessage from 'format-message';
import { IntentField, RecognizerField, QnAActionsField } from '@bfc/adaptive-form';

export const DefaultFormSchema: FormUISchema = {
  ...
  [SDKKinds.ForeachPage]: {
    label: () => formatMessage('Loop: For each page (multiple items) 2222'),
    subtitle: () => formatMessage('For Each Page22222'),
