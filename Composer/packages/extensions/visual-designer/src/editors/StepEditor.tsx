...
export class StepEditor extends React.Component<any, any> {
  constructor(props) {
    super(props);
    this.state = {
      stepGroupBoundary: measureJsonBoundary(props.data),
    };
  }

  render(): JSX.Element {
    const { id, data, onEvent } = this.props;
    const { stepGroupBoundary } = this.state;
